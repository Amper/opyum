# -*- coding: utf-8 -*-
#
# opyum documentation build configuration file.
#
...
project = u'opyum'
copyright = u'2015, Alexander Marshalov'
...
latex_documents = [
  ('index', 'opyum.tex', u'opyum Documentation',
   u'Alexander Marshalov', 'manual'),
]
...
man_pages = [
    ('index', 'opyum', u'opyum Documentation',
     [u'Alexander Marshalov'], 1)
]
